            ...
            ajax: {
                ...
                data: function (e) {
                    for (var t in Array.isArray(e.order) && (e.order = e.order.map((function (e) {
                        ...
                        }))), "undefined" != typeof csrfData && (e[csrfData.token_name] = csrfData.hash), n) e[t] = $(n[t]).val();
...
function toggle_small_view(e, t) {
    if (!is_mobile() && $("#small-table").hasClass("hide") && $(".small-table-right-col").hasClass("col-md-12")) return $("#small-table").toggleClass("hide"), $(".small-table-right-col").toggleClass("col-md-12 col-md-7"), void $(window).trigger("resize");
...
function kanban_load_more(e, t, a, i, n) {
    ...
    if (d <= r) {
        ...
        0 != c.length && "" !== c.val() && (o.sort_by = c.val(), o.sort = p), void 0 !== l && "" !== l && (o.search = l), $.each($("#kanban-params input"), (function () {
            ...
            d++, $('[data-load-status="' + e + '"]').before(a), $('[data-col-status-id="' + e + '"]').attr("data-total", parseInt($('[data-col-status-id="' + e + '"]').attr("data-total")) + $("<ul></ul>").append(a).find("li").length), $(t).attr("data-page", d), fix_kanban_height(i, n)
        })).fail((function (e) {
...
function _lead_init_data(e, t) {
    var a = window.location.hash,
        i = $("#lead-modal");
    $("#lead_reminder_modal").html(e.leadView.reminder_data), i.find(".data").html(e.leadView.data), i.modal({
        show: !0,
        backdrop: "static"
    }), init_tags_inputs(), init_selectpicker(), init_form_reminder(), init_datepicker(), init_color_pickers(), custom_fields_hyperlink(), validate_lead_form();
    if (["#tab_lead_profile", "#attachments", "#lead_notes", "#lead_activity", "#gdpr"].indexOf(a) > -1 && (window.location.hash = a), initDataTableInline($("#consentHistoryTable")), $("#lead-modal").find(".gpicker").googleDrivePicker({
            onPick: function (e) {
...
function recalculate_checklist_items_progress() {
    var e = $('input[name="checklist-box"]:checked').length,
        ...
        a = 0,
        i = $(".task-progress-bar");
    if ($(".task-total-checklist-completed").text(e), 0 == t ? ($("body").find(".chk-heading").remove(), $("#task-no-checklist-items").removeClass("hide")) : $("#task-no-checklist-items").addClass("hide"), !(t > 2)) return i.parents(".progress").addClass("hide"), e > 0 ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"), !1;
    i.parents(".progress").removeClass("hide"), 0 == (a = 100 * e / t) ? $(".task-progress-bar").addClass("text-dark") : $(".task-progress-bar").removeClass("text-dark"), i.css("width", a.toFixed(2) + "%"), i.text(a.toFixed(2) + "%"), e > 0 ? $(".chk-toggle-buttons").removeClass("hide") : $(".chk-toggle-buttons").addClass("hide"), 100 == a ? i.removeClass("progress-bar-default").addClass("progress-bar-success") : i.removeClass("progress-bar-success").addClass("progress-bar-default")
}
...
function _init_timers_top_html(e) {
    ...
    e.total_timers > 0 ? t.removeClass("hide").html(e.total_timers) : t.addClass("hide"), e.total_timers > 0 ? $("#top-timers").find("svg").addClass("tw-animate-spin") : $("#top-timers").find("svg").removeClass("tw-animate-spin"), $("#started-timers-top").html(e.html)
}
...
function tasks_kanban_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        })), task_mark_as(a, $(e.item).attr("data-task-id")), check_kanban_empty_col("[data-task-id]"), setTimeout((function () {
...
function load_small_table_item(e, t, a, i, n) {
    ...
    "" === s || window.location.hash ? window.location.hash && !e && (e = window.location.hash.substring(1)) : (e = s, $('input[name="' + a + '"]').val("")), void 0 !== e && "" !== e && (destroy_dynamic_scripts_in_element($(t)), $("body").hasClass("small-table") || toggle_small_view(n, t), $('input[name="' + a + '"]').val(e), do_hash_helper(e), $(t).load(admin_url + i + "/" + e), $("html, body").animate({
...
function add_item_to_table(e, t, a, i) {
    if ("" !== (e = void 0 === e || "undefined" == e ? get_item_preview_values() : e).description || "" !== e.long_description || "" !== e.rate) {
        ...
        return get_taxes_dropdown_template(l, e.taxname).done((function (a) {
            if(e.group_name != undefined){
                g= '<input type="hidden" class="order" name="newitems[' + s + '][order]"><input type="input" class="form-control" name="newitems[' + s + '][group_name]" value="' + e.group_name + '"></td>';
            }else{
                g= '<input type="hidden" class="order" name="newitems[' + s + '][order]"></td>' ;
            }
            n +=  g + ' ', n += "</td>", n += '<td class="bold description"><textarea name="newitems[' + s + '][description]" class="form-control" rows="5">' + e.description + "</textarea></td>", n += '<td><textarea name="newitems[' + s + '][long_description]" class="form-control item_long_description" rows="5">' + e.long_description.replace(d, "\n") + "</textarea></td>";
            ...
            l.length > 0 && $.each(l, (function () {
                ...
                if (a.is(":checkbox")) {
                ...
                } else if (a.is("input") || a.is("textarea")) a.is("input") ? e.find("[data-fieldid]").attr("value", a.val()) : e.find("[data-fieldid]").html(a.val()), e.find("[data-fieldid]").attr("name", i), "1" == e.find("[data-fieldid]").attr("data-custom-field-required") && (r = !0), t = e.html();
                else if (a.is("select")) {
                    ...
                    c.attr("name", i);
                    var _ = c.clone();
                    p.append(_), $.each(d, (function (e, t) {
                        p.find('select option[value="' + t + '"]').attr("selected", !0)
                    })), t = p.html()
                }
                n += '<td class="custom_field">' + t + "</td>"
            })), n += '<td><input type="number" min="0" onblur="calculate_total();" onchange="calculate_total();" data-quantity name="newitems[' + s + '][qty]" value="' + e.qty + '" class="form-control">', e.unit && void 0 !== e.unit || (e.unit = ""), n += '<input type="text" placeholder="' + app.lang.unit + '" name="newitems[' + s + '][unit]" class="form-control input-transparent text-right" value="' + e.unit + '">', n += "</td>";
            if(e.cost != undefined){
                n += '<td class="cost"><input type="number" data-toggle="tooltip" title="Cost" name="newitems[' + s + '][cost]" value="' + e.cost + '" class="form-control"></td>';
                n += '<td class="profit"><input type="number" data-toggle="tooltip" title="Profit" name="newitems[' + s + '][profit]" value="' + e.profit + '" class="form-control"></td>';
            }
            ...
            n += '<td class="taxrate">' + a + "</td>", n += '<td class="amount" align="right">' + format_money(o, !0) + "</td>", n += '<td><a href="#" class="btn btn-danger pull-left" onclick="delete_item(this,' + t + '); return false;"><i class="fa fa-trash"></i></a></td>', n += "</tr>", $("table.items tbody").append(n), $(document).trigger({
...
function get_item_preview_values() {
    var e = {};
    return e.description = $('.main textarea[name="description"]').val(), e.group_name = $('.main input[name="group_name"]').val(), e.long_description = $('.main textarea[name="long_description"]').val(), e.qty = $('.main input[name="quantity"]').val(), e.taxname = $(".main select.tax").selectpicker("val"), e.rate = $('.main input[name="rate"]').val(),e.cost = $('.main input[name="cost"]').val(),e.profit = $('.main input[name="profit"]').val(), e.unit = $('.main input[name="unit"]').val(), e
}
...
function estimates_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        $.each($(e.item).parents(".pipeline-status").find("li"), (function (e, t) {
            ...
            i && a.order.push([i, e + 1])
        })), check_kanban_empty_col("[data-estimate-id]"), setTimeout((function () {
...
function proposals_pipeline_update(e, t) {
    if (t === e.item.parent()[0]) {
        ...
        $.each($(e.item).parents(".pipeline-status").find("li"), (function (e, t) {
            ...
            i && a.order.push([i, e + 1])
        })), check_kanban_empty_col("[data-proposal-id]"), setTimeout((function () {
...
function delete_template(e, t, a) {
    confirm_delete() && $.post(admin_url + "templates/delete/" + a).done((function (a) {
        !0 !== (a = JSON.parse(a)).success && "true" != a.success || ("proposals" === t ? $(e).parents(".proposal-templates-wrapper").html("") : "contracts" === t && $(e).parents(".contract-templates-wrapper").html(""), get_templates(t))
    }))
}
...
function retrieve_imap_folders(e, t) {
    ...
    return $("#folders-loader").addClass("spinning").removeClass("hidden"), $.post(e, t).done((function (e) {
        if ((e = JSON.parse(e)).hasOwnProperty("alert_type")) alert_float(e.alert_type, e.message);
            ...
            })), i.html(t), i.selectpicker("refresh"), n || i.selectpicker("val", i.find("option:eq(0)")[0].value)
        }
        a.resolve(e)
    })).fail((function (e) {
        a.reject(e)
...
function add_batch_payment() {
    $("#modal-wrapper").load(admin_url + "payments/batch_payment_modal", (function () {
        $("#batch-payment-modal").is(":hidden") && $("#batch-payment-modal").modal({
            backdrop: "static",
            show: !0
        }), init_selectpicker(), init_datepicker();
        ...
        })), appValidateForm($("#batch-payment-form"), {}), $(".batch_payment_item").each((function () {
...
$("body").on("loaded.bs.select change", "select.ajax-search", (function (e) {
    ...
    })), t > 0 && $("#menu, #setup-menu-wrapper").css("top", t + 70 + "px")), $("form").has('[data-entities-encode="true"]').on("submit.app.entity", (function (e) {
    ...
    if (s && $("#search_input").val(s).trigger("keyup"), $("body").on("blur", "#timesheet_duration", (function () {
        ...
        })), $("body").on("show.bs.select", "select.checklist-items-template-select", _make_task_checklist_items_deletable), $("body").on("refreshed.bs.select", "select.checklist-items-template-select", _make_task_checklist_items_deletable), $("body").on("changed.bs.select", "select", (function (e) {
            ...
            if ("" === n && t.parents(".form-group").addClass("has-error"), "" === s && a.parents(".form-group").addClass("has-error"), "" === o && i.parents(".form-group").addClass("has-error"), "" !== n && "" !== s || "" !== o) {
                var l = {};
                l.timesheet_duration = o, l.start_time = n, l.end_time = s, l.timesheet_task_id = $(this).data("task-id"), l.note = $("body").find("#task_single_timesheet_note").val(), l.timesheet_staff_id = $("body").find('#task-modal select[name="single_timesheet_staff_id"]').val(), $.post(admin_url + "tasks/log_time", l).done((function (e) {
                    !0 === (e = JSON.parse(e)).success || "true" == e.success ? (init_task_modal(l.timesheet_task_id), alert_float("success", e.message), setTimeout((function () {
                        reload_tasks_tables()
    ...
    if ((table_leads = $("table.table-leads")).length) {
        ...
        p.length > 0 && (_.push(p.index()), m.push(p.index())), _table_api = initDataTable(table_leads, admin_url + "leads/table", m, _, c, [table_leads.find("th.date-created").index(), "desc"]), _table_api && p.length > 0 && _table_api.on("draw", (function () {
    ...
    if ($("body").on("change", 'input[name="contacted_today"]', (function () {
            ...
            var e = $("#bulk_change");
            !0 === $(this).prop("checked") ? (e.find("select").selectpicker("val", ""), e.addClass("hide"), $(".mass_delete_separator, merge_tickets_checkbox").addClass("hide"), $("#merge_tickets").prop("checked", !1)) : (e.removeClass("hide"), $(".mass_delete_separator, merge_tickets_checkbox").removeClass("hide"))
    ...
    $("body").on("submit", "._transaction_form", (function () {
        ...
        if ("" === $('select[name="discount_type"]').val() && 0 != $(this).val()) {
            ...
            return alert("You need to select discount type"), $("html,body").animate({
                scrollTop: 0
