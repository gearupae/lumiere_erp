         ...
         ?>
            ...
            <div class="col-md-12">
             ...
             echo '<option value="' . $rel_val['id'] . '" selected>' . $rel_val['name'] . '</option>';
                           ...
                           ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <?php $value = (isset($proposal) ? $proposal->prepared_by : ''); ?>
                                        <?php echo render_input('prepared_by', 'Prepared By', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php $value = (isset($proposal) ? $proposal->c_phone : ''); ?>
                                        <?php echo render_input('c_phone', 'C phone', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php $value = (isset($proposal) ? $proposal->project : ''); ?>
                                        <?php echo render_input('project', 'Project', $value); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel-body">
                        <?php
                            $value = (isset($proposal) ? $proposal->clientnote : get_option('predefined_clientnote_proposal'));
                            echo render_textarea('clientnote', 'estimate_add_edit_client_note', $value, [], [], '','tinymce');

                            $value = (isset($proposal) ? $proposal->terms : get_option('predefined_terms_estimate'));
...
$('#profit').on('change', function() {
    ...
    var profitPercentage = calculateProfitPercentage(cost, profit) ;
...
function calculateSellingPrice(cost, profitPercentage) {
    // Convert profit percentage to decimal form
    var profitDecimal = profitPercentage / 100;

    // Calculate selling price
    var sellingPrice = parseInt(cost) + parseInt(cost * profitDecimal);
    var profit = parseInt(sellingPrice) - parseInt(cost);
    $('#cost_p').val(profitPercentage);
    $('#rate').val(sellingPrice);
    $('#profit').val(profit);

}
function calculateProfitPercentage(cost, profit) {
