   ...
   <div class="row">
      <div class="col-md-4">
         <div class="form-group">
            ...
            <select name="invoice_type" class="selectpicker"  data-width="100%" data-none-selected-text="">
              
               <option value=""> All invoices</option>
               <option value="1">Credit note applied</option>
               <option value="2">Without credit Notes</option>
