            ...
            <div class="col-md-6">
               ...
               ?>
                ...
                <div class="col-md-6">
                                        ...
                                        $value = (isset($proposal) ? $proposal->prepared_by : ''); 
                                    }else{
                                        $value = (isset($estimate) ? $estimate->prepared_by : ''); 
                                    }
                                            ?>
                                        <?php echo render_input('prepared_by', 'prepared_by', $value); ?>
                                    </div>
                                    <div class="col-md-6">
                                        <?php if(isset($proposal)){
                                        $value = (isset($proposal) ? $proposal->c_phone : ''); 
                                        $project = (isset($proposal) ? $proposal->project : ''); 
                                    }else{
                                        $value = (isset($estimate) ? $estimate->c_phone : ''); 
                                        $project = (isset($estimate) ? $estimate->project : ''); 
                                    }
                                            ?>
                                        <?php echo render_input('c_phone', 'c_phone', $value); ?>
                                        
                                    </div>
                                    <div class="col-md-6">
                                        <?php echo render_input('project', 'Project', $project); ?>
                                    </div>
