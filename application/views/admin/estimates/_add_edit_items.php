    ...
    <div class="row">
        ...
        <div class="col-md-8 text-right show_quantity_as_wrapper">
            ...
            <?php if (isset($type) && ($type == "proposal")) { ?>
                <div class="mtop10">
                    <span><?php echo _l('Show Rate'); ?></span>
                    <div class="radio radio-primary radio-inline">
                    <input type="radio" value="1" name="show_rate"
                        <?php echo isset($proposal) && $proposal->show_rate == 1 ? 'checked' : 'checked'; ?>>
                    <label for="1"><?php echo _l('Yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="0" name="show_rate"
                        <?php echo isset($proposal) && $proposal->show_rate == 0 ? 'checked' : ''; ?>>
                    <label for="0"><?php echo _l('No'); ?></label>
                </div>
              
                </div>
            <?php }  elseif (isset($type) && ( $type = "estimate")) { ?>
                <div class="mtop10">
                    <span><?php echo _l('Show Rate'); ?></span>
                    <div class="radio radio-primary radio-inline">
                    <input type="radio" value="1" name="show_rate"
                        <?php echo isset($estimate) && $estimate->show_rate == 1 ? 'checked' : 'checked'; ?>>
                    <label for="1"><?php echo _l('Yes'); ?></label>
                </div>
                <div class="radio radio-primary radio-inline">
                    <input type="radio" value="0" name="show_rate"
                        <?php echo isset($estimate) && $estimate->show_rate == 0 ? 'checked' : ''; ?>>
                    <label for="0"><?php echo _l('No'); ?></label>
                </div>
                </div>
            <?php } ?>
            ...
            <thead>
                ...
                <?php if (isset($type) &&(($type == "proposal") ||( $type = "estimate"))) { ?>
                  ...
                  ?>
                    ...
                    <?php } else{ ?>
                        <th width="25%" align="right"><?php echo _l('estimate_table_rate_heading'); ?></th>
                    <?php } ?>
            ...
            <tbody>
                ...
                <?php if (isset($type) && (($type == "proposal") ||( $type = "estimate"))) { ?>
                    ...
                    <?php if (isset($type) && ($type == "proposal")) { ?>
                        ...
                        <td>
                        <input type="number" id="profit" name="profit"  value="0" class="form-control"
                                placeholder="<?php echo _l('Profit'); ?>">
                            <input type="text" id="cost_p"  value="100" class="form-control"
                                placeholder="<?php echo _l('Percentage'); ?>">
                        </td>
                    <?php } ?>
                        <td>
                ...
                <?php if (isset($estimate) || isset($add_items)) {
                         ...
                         foreach ($add_items as $item) {
                             ...
                             if ((isset($type) && (($type == "proposal") ||( $type = "estimate")))) {
                                $table_row .= '<input type="text" placeholder="Group name" name="' . $items_indicator . '[' . $i . '][group_name]" class="form-control" value="' . $item['group_name'] . '">';
                             }
                             $table_row .= '</td>';
