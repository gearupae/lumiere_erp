...
class Proposals extends AdminController
{
    ...
    public function convert_to_estimate($id)
    {
        ...
        if ($this->input->post()) {
           $proposal_data = $this->proposals_model->get($id);
            $data = ($this->input->post());
            $data['billing_street'] = $proposal_data->address;
            $data['billing_city'] = $proposal_data->city;
            $data['billing_state'] = $proposal_data->state;
            $data['billing_zip'] = $proposal_data->zip;
            $data['billing_country'] = $proposal_data->country;
